...
disp('Setting parameters in setup_flyer_ideal_stable');
    %Changable Parameters
        %Rotor properties
        h_r = .068; %Height of rotor cg below flyer cg (cg assumed axial) (meters) (positive is down)
        m_r = .063; %rotor mass in kg
        Ir_r = [203536.211032,0,0;0,26959.742608,0;0,0,182477*1.5]*1e-9; %Rotor inertia at rotor cg in flyer frame

        %Stator properties
        h_s = -.026; %Height of stator cg below flyer cg (cg assumed axial) (meters) (positive is down)
        m_s = .164; %stator mass in kg
        Is_s = [624513.130008,0,0;0,587292.296260,0;0,0,65063/1.5]*1e-9; %Stator inertia at stator cg in flyer frame
        ...
        h_d = -.01; %Height of center of drag plate below stator cg (meters) (positive is down)
