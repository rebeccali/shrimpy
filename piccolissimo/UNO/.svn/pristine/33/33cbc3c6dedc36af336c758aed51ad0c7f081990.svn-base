disp('Setting parameters in setup_flyer_UNO_v1_3RimBatt');
clearvars -global
...
%         Is_s = [800000,0,0;0,800000,0;0,0,1280000]*1e-9; %Stator inertia at stator cg in flyer frame % center battery 
        m_s = .190; %stator mass in kg
        Is_s = [1350000,0,0;0,1350000,0;0,0,2450000]*1e-9; %Stator inertia at stator cg in flyer frame % rim batteries 
        ...
        h_d = -.018 - h_cg; %Height of center of drag plate below FLYER cg (meters) (positive is down) default: -.014 - h_cg;
