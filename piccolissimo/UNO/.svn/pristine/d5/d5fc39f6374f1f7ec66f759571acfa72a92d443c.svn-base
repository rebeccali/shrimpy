disp('Setting parameters in setup_flyer_Spider_V3_4RimBatt');
clearvars -global
global R_nu Cd_segmented Cl_segmented Xbase B_p B_d h_r m_r Ir_r h_s m_s Is_s h_p R_p beta_p chord_p H_p h_d R_d1 R_d2 beta_d chord_d H_d rho g S_s_f S_r_f area_p area_d bladeProperties_p bladeProperties_d1 bladeProperties_d2 m I_tot counter r_m K_t_m L_m rotorErrorAngle Rs_b
    ...
    %Changable Parameters
        ...
        Xbase = [nan; 0; 0; 0; 0; 0; 0; -600.0485; 33.0270; 0; 0; 0; 0; 0; 0; 0; 0; -5.6941];
        ...
        %% Stator properties
        h_s = -0.0013 - h_cg;
        m_s = .188; %stator mass in kg, rim batteries      
        Is_s = [2390000,0,0;0,2390000,0;0,0,4520000]*1e-9; %Stator inertia at stator cg in flyer frame, rim batteries 
