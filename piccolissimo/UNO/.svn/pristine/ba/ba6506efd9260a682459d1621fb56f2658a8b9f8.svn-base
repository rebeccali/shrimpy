disp('Using propeller_apc_6x3_3D');
...
m_r = 4.35/1000 + 12.09/1000; %=.02302; %propeller mass + dys quanum 2206 rotor mass in kg
Ir_r = [ (38.7+885.08),0,0;0,(7070+885.08),0;0,0, (7070+1336.33)]*1e-9; %propeller intertia + dys quanum 2206 rotor %Rotor inertia at rotor cg in flyer frame 

rise = [4.5 8 4 2.5 1.5]/1000; %in meters
run = [11 17 14 9 5]/1000;
