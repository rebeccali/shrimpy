disp('Using body_UnoOffset_actual');
...
span_d_nonuniform = [0 37 129.5 185]/1000;
beta_d_nonuniform = deg2rad(180-[70 64 19 16]);
chord_d_nonuniform = [35 44 82 128]/1000;
R_d = max(span_d_nonuniform);